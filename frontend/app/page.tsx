  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--surface)", fontFamily: "'Inter', system-ui, sans-serif" }}>
      ...
      <section style={{ textAlign: "center", padding: "80px 24px 60px", background: "var(--cream)" }}>
        ...
        <div style={{ display: "inline-flex", flexDirection: "column", alignItems: "center", background: "var(--card)", border: "1px solid var(--border)", borderRadius: 18, padding: "28px 40px", marginBottom: 36, boxShadow: "var(--shadow-md)" }}>
      ...
      <section style={{ background: "var(--cream)", borderTop: "1px solid var(--border)", padding: "60px 24px", textAlign: "center" }}>
        <h2 style={{ fontSize: "1.8rem", fontWeight: 800, color: "var(--text-primary)", marginBottom: 14 }}>Ready to take control of your money?</h2>
      ...
      <footer style={{ borderTop: "1px solid var(--border)", padding: "20px 48px", display: "flex", justifyContent: "space-between", alignItems: "center", background: "var(--surface)", flexWrap: "wrap", gap: 12 }}>
